...
int main(int argc,char* argv[])
{
	...
	int ret_usart,ret0,ret1,ret2,ret3,ret4,ret5,ret6,ret8;          //接受返回值，用于判断
	identify_flag = 0;
	go_net_flag = 0;
	NET_FLAG = 0;
	device_flag = 0;
	...
	file_init_common();
	pthread_t id_client,id_usart,id_heart_jump,id_resend,id_timer,id_get_status,id_human_body,id_my_delay;
